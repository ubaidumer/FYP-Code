...
class workHistory extends Component {
    ...
    render() {
      ...
      <CardContent>
        <Typography  color="textSecondary" gutterBottom style={{backgroundColor:'#f59118',color:'white'}}>
        <li> Order:{t._id} </li>
        </Typography>
      ...
      <li>  End Time:    {t.endtime}</li>
        ...
        <FormControlLabel
        control={<Button style={{color:'#f59118'}} checked={this.state.checked} onClick={()=>this.setState({checked:!this.state.checked})} ><VisibilityIcon/> </Button>}
        label="View Details"
      />
      <div>
